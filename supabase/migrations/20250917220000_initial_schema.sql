...
CREATE TABLE IF NOT EXISTS "public"."rooms" (
    ...
    "privacy" public.room_privacy NOT NULL DEFAULT 'public'::public.room_privacy,
...
CREATE TABLE IF NOT EXISTS "public"."friends" (
    ...
    CONSTRAINT "friends_user_id1_fkey" FOREIGN KEY (user_id1) REFERENCES public.profiles(id) ON DELETE CASCADE,
    CONSTRAINT "friends_user_id2_fkey" FOREIGN KEY (user_id2) REFERENCES public.profiles(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "public"."room_join_requests" (
    ...
    CONSTRAINT "room_join_requests_room_id_fkey" FOREIGN KEY (room_id) REFERENCES public.rooms(id) ON DELETE CASCADE,
    CONSTRAINT "room_join_requests_user_id_fkey" FOREIGN KEY (user_id) REFERENCES public.profiles(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS "public"."conversation_messages" (
    ...
    CONSTRAINT "conversation_messages_parent_message_id_fkey" FOREIGN KEY (parent_message_id) REFERENCES public.conversation_messages(id),
    CONSTRAINT "conversation_messages_user_id_fkey" FOREIGN KEY (user_id) REFERENCES public.profiles(id) ON DELETE CASCADE
);
