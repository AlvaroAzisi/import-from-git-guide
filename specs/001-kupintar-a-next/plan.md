...
**Testing**: Vitest (frontend), Playwright (e2e), Supabase test suite (backend)
**Target Platform**: Web (modern browsers), Linux server (backend), Vercel (frontend hosting)
**Project Type**: web (frontend + backend monorepo)
**Performance Goals**: <200ms chat latency, scalable to 10k+ users, room size 30 (Free)/100 (Pro)
**Constraints**: RLS enforced, file uploads ≤2MB, avatars auto-resized 256x256, GDPR-like privacy, TLS everywhere
...
- Review best practices for integrating Paddle/LemonSqueezy, Midtrans/Xendit, and Stripe for global/regional payments
- Explore avatar upload/resize/storage flows with Supabase Storage and RLS
- Research gamification (XP, streaks, badges) data modeling in Postgres
- Review GDPR-like privacy/data retention enforcement in Supabase
- Investigate CI/CD best practices for Vercel + Supabase + GitHub Actions
