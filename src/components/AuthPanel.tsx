      ...
      if (isLogin) {
        ...
        if (data.user) {
          if (data.user.email_confirmed_at) {
            ...
            setGeneralError('Please check your email and click the confirmation link to complete registration.');
          }
        }
      }
    } catch (error: any) {
            ...
            <div className="backdrop-blur-md bg-white/30 border border-white/20 rounded-3xl shadow-2xl p-8 w-full max-w-md relative overflow-hidden">
              ...
              <div className="text-center mb-8 relative z-10">
                ...
                <p className="text-gray-600">
                  {isLogin ? 'Sign in to find your study buddy' : 'Create your account to get started'}
                </p>
              </div>
