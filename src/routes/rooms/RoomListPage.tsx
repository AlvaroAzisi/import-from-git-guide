...
/**
 * RoomListPage - List of rooms joined or created by user
 * Route: /ruangku
 */
export const RoomListPage = () => {
  ...
  return (
    <div className="max-w-[1600px] 2xl:max-w-screen-2xl mx-auto px-4 md:px-6 lg:px-8 2xl:px-12 py-6 md:py-8 lg:py-10 2xl:py-12">
      <motion.div
      ...
      >
        ...
        <div className="backdrop-blur-md bg-background/40 dark:bg-background/40 rounded-2xl md:rounded-3xl border border-border/20 shadow-lg p-6 md:p-8 2xl:p-10">
          ...
          <p className="text-sm md:text-base 2xl:text-lg text-muted-foreground">
            Manage your study rooms and join new ones.
          </p>
        </div>
