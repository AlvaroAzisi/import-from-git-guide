...
const ProfilePage: React.FC = () => {
  ...
  if (!user || !profile) {
    console.log('[ProfilePage] No user or profile, redirecting', {
      user: !!user,
      profile: !!profile,
    });
  ...
  const handleSaveBio = async () => {
    setSaving(true);
    console.log('[ProfilePage] Updating bio and interests:', {
      bio: editForm.bio,
      interests: editForm.interests,
    });
              ...
              <div className="flex-1">
                {isEditing ? (
                  ...
                  >
                    ...
                    <p className="text-blue-500 dark:text-blue-400 text-lg font-medium mb-1">
