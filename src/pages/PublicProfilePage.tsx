              ...
              {user && (
                <div className="flex gap-3 justify-center md:justify-start">
                  <Button
                    ...
                    disabled={sendingRequest || friendshipStatus === 'pending' || friendshipStatus === 'accepted'}
                    className={`${
        ...
        {(profile.bio || (profile.interests && profile.interests.length > 0)) && (
          ...
          >
            ...
            {profile.interests && Array.isArray(profile.interests) && profile.interests.length > 0 && (
              <div>
                <h3 className="text-xl font-bold text-gray-800 dark:text-gray-200 mb-3">Interests</h3>
